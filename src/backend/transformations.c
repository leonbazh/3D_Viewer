 ...
 *
 * Эта функция сдвигает все вершины модели на указанные расстояния по осям X, Y и Z.
 *
 ...
 * Углы передаются в градусах, но конвертируются в радианы для тригонометрических вычислений.
 *
 * @param model Указатель на структуру модели, содержащую массив вершин.
 ...
 *
 * Эта функция увеличивает или уменьшает размер модели путем умножения координат каждой вершины
 * на указанный коэффициент масштабирования.
 *
 * @param model Указатель на структуру модели, содержащую массив вершин.
 * @param scale_factor Коэффициент масштабирования. Значение >1 увеличивает модель, значение <1 уменьшает её.
 */
